...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::strobe_CE(){
...
template <typename CSN_pin_t, typename CE_pin_t> uint8_t Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::read_status(){
  // Begin command.
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::write_register(const Register_t reg, const uint8_t value){
  ...
  SPI::transceive(Opcode_WRITE_REGISTER | reg);
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::write_registers(const Register_t reg, uint8_t *buf, uint8_t len){
  // Sanity check
  if(reg > Register_Max) return;
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::write_register_bits(const Register_t reg, const uint8_t mask, bool value){
...
// Read a register.
template <typename CSN_pin_t, typename CE_pin_t> uint8_t Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::read_register(const Register_t reg) const{
  // Sanity check
  ...
  SPI::transceive(Opcode_READ_REGISTER | reg);
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::read_registers(const Register_t reg, uint8_t* buf, uint8_t len) const{
  // Sanity check
  if(reg > Register_Max) return;
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::set_power_state(bool new_value){
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::set_features_enabled(bool new_value){
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::set_CRC_size(uint8_t new_value){
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::set_receive_packet_size(const Pipe_t pipe, const PacketSize_t new_packetSize){
// Sanity checks
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::set_dynamic_payload_allowed(const Pipe_t pipe, bool new_value){
  // Sanity check
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::set_all_dynamic_payloads_allowed(bool new_value){
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::set_auto_acknowledge(const Pipe_t pipe, const bool new_value){
  // Sanity check
  if(pipe > Pipe_Max) return;
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::set_auto_retransmit_delay(ARD_t new_delay){
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::set_auto_retransmit_count_limit(uint8_t new_limit){
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::set_channel(Channel_t new_channel, const bool clamp_2MHz){
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::set_frequency(Frequency_t new_frequency){
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::set_gain(Gain_t new_gain){
  // Clamp to limits.
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::set_data_rate(const Rate_t new_rate){
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::set_address_size(uint8_t new_size){
  // Clamp to limits
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::set_TX_address(const uint32_t &new_address, const bool set_matching_ACK){
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::set_RX_address(const uint32_t &new_address, const bool enable_pipe, const uint8_t pipe){
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::set_RX_pipe_enabled(const bool new_value, const uint8_t pipe){
  // Sanity check
  if(pipe > Pipe_Max) return;
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::queue_TX_packet(const uint8_t* buf, uint8_t buf_len, const bool ack_requested){
...
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::queue_RX_packet(const uint8_t* buf, uint8_t buf_len, const Pipe_t rx_pipe){
...
// Retransmit a packet.
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::transmit_reused(){
  // Begin command.
  CSN_pin.set_output_low();
  // Opcode: Reuse TX payload.
  SPI::transmit(Opcode_REUSE_TX_PL);
  // End command.
  CSN_pin.set_output_high();
}
// Read the size of the packet in the front of the RX FIFO queue.
template <typename CSN_pin_t, typename CE_pin_t> uint8_t Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::read_received_packet_size(){
  // Begin command.
  CSN_pin.set_output_low();
  // Opcode: Read received-payload width.
  SPI::transmit(Opcode_R_RX_PL_WID);
  // Receive the width response.
  uint8_t size = SPI::receive();
  // End command.
  CSN_pin.set_output_high();
  // Return payload size.
  return size;
}
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::flush_transmit_buffer(){
  // Begin command.
  CSN_pin.set_output_low();
  // Opcode: Flush transmit FIFO.
  SPI::transmit(Opcode_FLUSH_TX);
  // End command.
  CSN_pin.set_output_high();
}
template <typename CSN_pin_t, typename CE_pin_t> void Nordic_nRF::nRF24L01P<CSN_pin_t, CE_pin_t>::flush_receive_buffer(){
  // Begin command.
  CSN_pin.set_output_low();
  // Opcode: Flush receive FIFO.
  SPI::transmit(Opcode_FLUSH_RX);
  // End command.
  CSN_pin.set_output_high();
}
