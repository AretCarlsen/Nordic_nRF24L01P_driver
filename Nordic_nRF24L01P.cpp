...
template <typename CSN_pin_t, typename CE_pin_t, typename SPI_bus_t> void Nordic_nRF24L01P<CSN_pin_t, CE_pin_t, SPI_bus_t>::init(bool power_up){
...
template <typename CSN_pin_t, typename CE_pin_t, typename SPI_bus_t> void Nordic_nRF24L01P<CSN_pin_t, CE_pin_t, SPI_bus_t>::write_address(const uint8_t reg, const uint8_t* new_address, uint8_t len){
  // Sanity check
...
template <typename CSN_pin_t, typename CE_pin_t, typename SPI_bus_t> void Nordic_nRF24L01P<CSN_pin_t, CE_pin_t, SPI_bus_t>::set_TX_address(const uint8_t* new_address, const uint8_t len, const bool set_matching_ACK){
...
template <typename CSN_pin_t, typename CE_pin_t, typename SPI_bus_t> void Nordic_nRF24L01P<CSN_pin_t, CE_pin_t, SPI_bus_t>::set_RX_address(const uint8_t* new_address, const uint8_t len, bool enable_pipe, uint8_t pipe){
...
template <typename CSN_pin_t, typename CE_pin_t, typename SPI_bus_t> void Nordic_nRF24L01P<CSN_pin_t, CE_pin_t, SPI_bus_t>::queue_packet(const uint8_t opcode, const uint8_t* buf, uint8_t buf_len){
  // Begin command.
  CSN_pin.set_output_low();
  // Send opcode.
...
template <typename CSN_pin_t, typename CE_pin_t, typename SPI_bus_t> uint8_t Nordic_nRF24L01P<CSN_pin_t, CE_pin_t, SPI_bus_t>::receive_packet(uint8_t *buf, uint8_t buf_len){
...
template <typename CSN_pin_t, typename CE_pin_t, typename SPI_bus_t> bool Nordic_nRF24L01P<CSN_pin_t, CE_pin_t, SPI_bus_t>::receive_packet(ReceivedPacket &packet){
